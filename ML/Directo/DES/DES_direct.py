...
def main():
    print("2 Round DES dataset using Keras/TensorFlow ")

    print("Loading data into memory \n")
    train_data = "dataset_2R_train.txt"
    test_data = "dataset_2R_test.txt"
    ...
    for foldtrain, foldtest in kfold.split(train_x, train_y):
        ...
        csv_logger = K.callbacks.CSVLogger('2R_2048_mse_adam_' + str(i) + 'fold.csv', separator=';', append=False)
        ...
        plt.savefig('acc_2R_2048_mse_adam_' + str(i) + 'fold.png', format='png')
        ...
        plt.savefig('loss_2R_2048_mse_adam_' + str(i) + 'fold.png', format='png')
