...
def main():
    ...
    for foldtrain, foldtest in kfold.split(train_x, train_y):
        ...
        csv_logger = K.callbacks.CSVLogger(str(n_rounds) + 'R_96_2048_mse_adam_' + str(i) + 'fold.csv', separator=';', append=False)
        ...
        plt.savefig('acc_' + str(n_rounds) + 'R_96_2048_mse_adam_' + str(i) + 'fold.png', format='png')
        ...
        plt.savefig('loss_' + str(n_rounds) + 'R_96_2048_mse_adam_' + str(i) + 'fold.png', format='png')
