...
def main():
    ...
    for foldtrain, foldtest in kfold.split(train_x, train_y):
        ...
        csv_logger = K.callbacks.CSVLogger('noMC_' + str(n_rounds) + 'R_2048_mse_adam_' + str(i) + 'fold.csv', separator=';', append=False)
        ...
        plt.savefig('acc_noMC_' + str(n_rounds) +'R_2048_mse_adam_' + str(i) + 'fold.png', format='png')
        ...
        plt.savefig('loss_noMC_' + str(n_rounds) +'R_2048_mse_adam_' + str(i) + 'fold.png', format='png')
